...
![1545045660839](../io%E4%B8%8E%E5%A4%9A%E7%BA%BF%E7%A8%8B/assets/1545045660839.png)

## JMM 如何解决可见性问题

JVM 内部的运行时数据区，但是真正程序执行，实际是要跑在具体的处 理器内核上。你可以简单理解为，把本地变量等数据从内存加载到缓存、寄存器，然后运算结束 写回主内存。你可以从下面示意图，看这两种模型的对应。 

![1545045352413](../io%E4%B8%8E%E5%A4%9A%E7%BA%BF%E7%A8%8B/assets/1545045352413.png)
